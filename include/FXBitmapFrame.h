...
public:
  ...
  FXBitmapFrame(FXComposite* p,FXBitmap *bmp,FXuint opts=static_cast<FXuint>(FRAME_SUNKEN)|static_cast<FXuint>(FRAME_THICK),FXint x=0,FXint y=0,FXint w=0,FXint h=0,FXint pl=0,FXint pr=0,FXint pt=0,FXint pb=0);
